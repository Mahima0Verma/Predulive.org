...
$msg="";
           if(ISSET($_POST['save'])){
$Tname = mysqli_real_escape_string($con,$_POST['team_member_name']);
...
if($status=="OK")
{
$qb=mysqli_query($con,"INSERT INTO team (team_member_name, designation, facebook_link,instagram_link,linkedin_link,twitter_link,ufile) VALUES ('$Tname', '$designation', '$facebook_link','$instagram_link','$linkedin_link','$twitter_link', '$new_file_name')");
...
if($_SERVER['REQUEST_METHOD'] == 'POST')
   ...
   <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="firstnameInput" name="team_member_name" placeholder="Enter Name">
                                                        </div>
                                                    </div>

                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="firstnameInput" class="form-label">Designation</label>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="firstnameInput" class="form-label">TwitterLink</label>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="firstnameInput" class="form-label">Linkedin_Link</label>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="firstnameInput" class="form-label"> Instagram Link</label>
                                                            <textarea class="form-control" id="Instagram_Link" name="Instagram_Link" rows="2"></textarea>
                                                        </div>
                                                    </div>
