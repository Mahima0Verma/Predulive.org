...
?>
                                                        <p class="text-uppercase fw-semibold fs-12 text-muted mb-1"> Total News</p>
...
?>
                                                        <p class="text-uppercase fw-semibold fs-12 text-muted mb-1"> Total Team Members</p>
...
?>
                                                        <p class="text-uppercase fw-semibold fs-12 text-muted mb-1"> Total Training and Program</p>
                                                        <h4 class=" mb-0"><span class="counter-value" data-target="<?php print $nux; ?>"></span></h4>
                                                    </div>
...
?>
                                                        ...
                                                        <p class="text-uppercase fw-semibold fs-12 text-muted mb-1"> Total Job Opportunities</p>
                                                        <h4 class=" mb-0"><span class="counter-value" data-target="<?php print $numrows; ?>"></span></h4>
                                                    </div>
...
?>
                                                        <p class="text-uppercase fw-semibold fs-12 text-muted mb-1"> No. of News</p>
                                                        <h4 class=" mb-0"><span class="counter-value" data-target="<?php print $nux; ?>"></span></h4>
                                                    </div>
...
?>
                                                        <p class="text-uppercase fw-semibold fs-12 text-muted mb-1"> Sucess stories</p>
                                                        <h4 class=" mb-0"><span class="counter-value" data-target="<?php print $nud; ?>"></span></h4>
                                                    </div>
