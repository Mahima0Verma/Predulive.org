                                    ...
                                    <ul class="nav nav-tabs-custom rounded card-header-tabs border-bottom-0" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" data-bs-toggle="tab" href="#personalDetails" role="tab" aria-selected="false">
                                                <i class="fas fa-home"></i> Add blog
                                            </a>
                                        </li>
...
if($status=="OK")
{
$qb=mysqli_query($con,"INSERT INTO blog (blog_title, blog_desc, blog_detail,ufile) VALUES ('$blog_title', '$blog_desc', '$blog_detail', '$new_file_name')");
...
if($_SERVER['REQUEST_METHOD'] == 'POST')
   ...
   <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="firstnameInput" name="blog_title" placeholder="Enter blog Title">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea class="form-control" id="exampleFormControlTextarea5" name="blog_desc" rows="2"></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea class="form-control" id="exampleFormControlTextarea5" name="blog_detail" rows="3"></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="hstack gap-2 justify-content-end">
                                                            <button type="submit" name="save" class="btn btn-primary">Add blog</button>
