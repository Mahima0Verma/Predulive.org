...
.thankyou-page ._header {
    ...
    padding: 100px 30px;
    text-align: center;
    background: #13357B url(https://codexcourier.com/images/main_page.jpg) center/cover no-repeat;
}
...
<div class="thankyou-page">
    ...
    <div class="_body">
        <div class="_box">
            <h2>
                <strong>Please check your email</strong> for further instructions on how to accelerate your startup journey.
            </h2>
            <p>
